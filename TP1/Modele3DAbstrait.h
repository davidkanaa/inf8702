...
public:
	...
	CModele3DAbstrait(float echelle, char * nomFichierTexture, TEXTypeEnum texType, bool compilerTex = true, bool mipmap = false, bool remplacerTexturage = false);
	/// constructeur créant un modèle 3D générique comportant plusieurs textures
	CModele3DAbstrait(float echelle, std::vector<char*> *nomsFichiersTextures, TEXTypeEnum texType, bool compilerTex = true, bool mipmap = false, bool remplacerTexturage = false);
...
protected:
	...
	virtual void remplacerTexturage(bool remplacerTextures = false);
	//On applique les textures
	virtual void appliquerTextures(bool remplacerTexturage);
