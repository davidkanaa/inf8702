...
///
///////////////////////////////////////////////////////////////////////////////
CModele3DAbstrait::CModele3DAbstrait(float echelle, char * nomFichierTexture, TEXTypeEnum texType = TYPE_TEXTURE2D, bool compilerTex, bool mipmap, bool remplacerTexturage) :
echelle_(echelle), texType_(texType), compilerTex_(compilerTex), mipmap_(mipmap)
{
	...
	this->remplacerTexturage(remplacerTexturage);
	this->appliquerTextures(remplacerTexturage);
}
...
///
///////////////////////////////////////////////////////////////////////////////
CModele3DAbstrait::CModele3DAbstrait(float echelle, std::vector<char*> *nomsFichiersTextures, TEXTypeEnum texType = TYPE_TEXTURE2D, bool compilerTex, bool mipmap, bool remplacerTexturage) :
echelle_(echelle), texType_(texType), compilerTex_(compilerTex), mipmap_(mipmap)
{
...
void CModele3DAbstrait::remplacerTexturage(bool remplacerTexturage)
{
...
void CModele3DAbstrait::appliquerTextures(bool remplacerTexturage)
{
	if (!remplacerTexturage && nomsFichiersTextures_.size() >= 1)
	{
